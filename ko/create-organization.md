...
![module_info](../static/images/module_info/조직과-프로젝트-생성.png)
...
### 단계 1. NHN Cloud 콘솔 접속하기 { #step-1-access-the-nhn-cloud-console }
...
### 단계 2. 조직 생성하기 { #step-2-create-an-organization }
...
### 단계 3. 프로젝트 생성하기 { #step-3-create-a-project }
...
### 단계 4. 리전 선택하기 { #step-4-select-a-region }
